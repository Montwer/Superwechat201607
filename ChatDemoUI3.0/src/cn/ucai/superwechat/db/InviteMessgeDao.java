...
public class InviteMessgeDao {
	...
	public Integer saveMessage(InviteMessage message){
		return SuperWeChatHelperDBManager.getInstance().saveMessage(message);
	}
	...
	public void updateMessage(int msgId,ContentValues values){
	    SuperWeChatHelperDBManager.getInstance().updateMessage(msgId, values);
	}
	...
	public List<InviteMessage> getMessagesList(){
		return SuperWeChatHelperDBManager.getInstance().getMessagesList();
	}
	
	public void deleteMessage(String from){
	    SuperWeChatHelperDBManager.getInstance().deleteMessage(from);
	}
	
	public int getUnreadMessagesCount(){
	    return SuperWeChatHelperDBManager.getInstance().getUnreadNotifyCount();
	}
	
	public void saveUnreadMessageCount(int count){
	    SuperWeChatHelperDBManager.getInstance().setUnreadNotifyCount(count);
	}
}
